...
def home(request):
    return render(request, "DjangoLoginSystem/index.html")
...
def signup(request):
    ...
    email.send()
        ...
        return render(request, "DjangoLoginSystem/signup.html")
...
def signin(request):
    if request.method == POST:
        ...
        if user is not None:
            ...
            return render(request, "DjangoLoginSystem/index.html",{'fname':fname})
        else:
            messages.error(request, "Wrong credentials")
            return redirect('Home')

    return render(request, "DjangoLoginSystem/signin.html")
